        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {challenges.map((item) => (
            <div
              key={item.id}
              className="pro-box
              group relative bg-[#FFFFFF] border-4 border-[#1E1E1E] rounded-2xl p-6 transition-all duration-300 ease-in-out shadow-[6px_6px_0px_#1E1E1E] hover:shadow-[12px_12px_0px_#ea580c] hover:-translate-x-1 hover:-translate-y-1"
            >
              {/* Top Tag Row */}
